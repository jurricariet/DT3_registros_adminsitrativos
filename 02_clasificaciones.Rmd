...
En primer lugar, el Transporte, agrupa a tres tipos: Terrestre, Aéreo y/o Acuático (Figura \@ref(fig:clasificaciontransporte)). 



```{r clasificaciontransporte, echo=FALSE, fig.cap="Figura N° 3A. Clasificación de los registros administrativos ligados al transporte por tipo de información" }
...
```{r clasificacionatractivos, echo=FALSE, fig.cap="Figura N° 3B. Clasificación de los registros administrativos ligados a los atractivos turísticos y a la oferta turística por tipo de información" }
...
```{r clasificacionsegundasviviendas, echo=FALSE, fig.cap="Figura N° 3C. Clasificación de los registros administrativos ligados a las segundas viviendas y al empleo por tipo de información" }
