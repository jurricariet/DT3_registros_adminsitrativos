...
```{r estudioslocalidade, echo=FALSE, fig.cap="Figura Nº 4. Resultados del estudio realizado por la localidad C" }
...
```{r temporadaalta, echo=FALSE, fig.cap="Figura N° 5/ B. Aplicación de coeficiente de Temporada Alta, obtenido del estudio realizado por la localidad C, a las cantidades de vehículos de todos los períodos (Temporada Alta, Fines de semana largo y Fuera de temporada)" }
...
```{r resultadosobtenidos, echo=FALSE, fig.cap="Figura N° 6. Resultados obtenidos por los estudios muestrales realizados por la localidad Norte" }
...
```{r arribosdeturistas, echo=FALSE, fig.cap="Figura N° 7. Estimación de coeficiente de arribos de turistas residentes sobre capacidad total" }
...
```{r llegadasportipo, echo=FALSE, fig.cap="Figura N° 8. Estimación de llegadas por tipo y residencia de visitante en cada período bajo estudio" }
